...
export function Layout({ title, children }: { title: string; children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-emerald-50 dark:from-slate-950 dark:to-slate-900">
      <header className="mx-auto flex w-full max-w-screen-2xl items-center justify-between px-6 py-6 2xl:px-10">
        <div>
      ...
      <main className="mx-auto w-full max-w-screen-2xl px-6 pb-12 2xl:px-10">{children}</main>
    </div>
  );
}
