      ...
      <SmoothScroll>
        <div className="bg-slate-950">
          <div className="mx-auto max-w-6xl px-4 py-8 sm:py-10 md:px-6 md:py-14">
            ...
            <section className="mt-12 grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-start sm:mt-16">
              <div className="rounded-2xl border border-slate-800/60 bg-slate-950/70 p-5 sm:p-6">
                <h2 className="text-xl font-semibold text-white sm:text-2xl">Why this works when Discord doesn't</h2>
              ...
              <div className="rounded-2xl border border-slate-800/60 bg-slate-950/60 p-5 text-slate-300 sm:p-6">
