              ...
              <MagicBento
                ...
                cards={[
                  ...
                  },
                  {
                    ...
                    description:
                      "Set step thresholds and the exact commands to run at each tier. Tweak rewards anytime without the difficulty of manually editing config files.",
                    label: "Rewards",
                  },
                  {
                    color: "#060010",
