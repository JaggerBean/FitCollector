      ...
      <div className="bg-white">
        ...
        <section className="mx-auto max-w-6xl px-6 pt-12 pb-10 md:pt-16">
            ...
            <Reveal delayMs={120}>
              <ShellCard>
                <div className="p-7">
                  ...
                  <Parallax strength={0.22} className="mt-6">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {solutionCards.map((c, idx) => (
              <Reveal key={c.title} delayMs={idx * 80}>
                <a
                  href={c.href}
                  className="group block rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.05)] transition hover:border-slate-300"
                >
                  <div className="text-xs font-medium uppercase tracking-[0.22em] text-emerald-700/80">{c.title}</div>
          ...
          <section className="border-y border-slate-200 bg-white">
            <div className="mx-auto max-w-6xl px-6 py-6">
              <div className="flex flex-wrap gap-2">
                {pillars.map((p, idx) => (
                  <Reveal key={p} delayMs={idx * 35}>
                    <span className="inline-block rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-700">
                      {p}
                    </span>
                  </Reveal>
                ))}
        ...
        <section className="mx-auto max-w-6xl px-6 py-14">
          <Reveal>
            <SectionHeader
              ...
              body="Items animate as they enter view, so it feels like you’re moving through a narrative instead of a static page."
              right={
